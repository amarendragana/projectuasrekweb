        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5"> 
                    <img alt="Rubick Tailwind HTML Admin Template" class="w-6" src="{{ asset('dist/images/coff.png') }}">
                    <span class="text-white text-lg ml-3">
                        Kelompok 2
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Rubick Tailwind HTML Admin Template" class="-intro-x w-1/4 -mt-16" src="{{ asset('dist/images/cover.png') }}"><p>
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Universitas <br> Mercu Buana</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Yogyakarta</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
